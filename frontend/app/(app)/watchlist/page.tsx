...
export default function WatchlistPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <h1 className="font-display text-2xl font-medium text-foreground sm:text-3xl">Watchlist</h1>
      <p className="mt-1 text-sm text-foreground-muted">Movies you&apos;ve queued up to watch next.</p>
      ...
      <div className="mt-6" aria-busy={entries === null}>
        {entries === null ? (
          ...
          <EmptyState
            ...
            description="Add movies you want to watch later from the movie catalog."
          />
        ) : (
