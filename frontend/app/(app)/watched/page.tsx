...
export default function WatchedPage() {
  const [entries, setEntries] = useState<WatchedEntry[] | null>(null);
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <h1 className="font-display text-2xl font-medium text-foreground sm:text-3xl">Watched</h1>
      <p className="mt-1 text-sm text-foreground-muted">Everything you&apos;ve already seen.</p>
      ...
      <div className="mt-6" aria-busy={entries === null}>
        {entries === null ? (
          ...
          <EmptyState
            ...
            description="Mark movies as watched from the catalog or a movie's detail page."
          />
        ) : (
